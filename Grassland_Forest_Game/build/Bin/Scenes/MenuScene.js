...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.phaser_ancho / 2 , 25, `>> (${this.currentAccount.slice(0, 6)}...${this.currentAccount.slice(-4)})`, {
        ...
        }).setOrigin(0.5).setScale(0.5, 0.5).setDepth(1);

        // TEXTO DE CARTERA

        this.add.text(this.phaser_ancho / 2 - 380, this.phaser_largo - 30, `©GRASSLAND FOREST - Version 1.0.1`, {
            fontFamily: '"PressStart2P"', // Fuente personalizada
